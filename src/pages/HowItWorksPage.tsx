    ...
    <div className="pt-24 pb-16 bg-gradient-to-b from-green-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900">How HealthTrack Works</h1>
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative mb-16 last:mb-0">
              {index !== steps.length - 1 && (
                <div className="absolute left-16 top-20 h-full w-0.5 bg-green-200" />
              )}
              <div className="flex items-start">
                <div className="flex-shrink-0">
                  <div className="relative z-10 w-12 h-12 flex items-center justify-center bg-green-600 rounded-full">
